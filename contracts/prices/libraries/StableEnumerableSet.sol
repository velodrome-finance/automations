...
library StableEnumerableSet {
    ...
    /**
     * @dev Returns the number of values in the set, excluding zeroes. O(1).
     */
    function lengthWithoutZeroes(Bytes32Set storage set) internal view returns (uint256) {
        return _lengthWithoutZeroes(set._inner);
    }
     ...
     * @dev Returns the number of values in the set, excluding zeroes. O(1).
     */
    function lengthWithoutZeroes(AddressSet storage set) internal view returns (uint256) {
        return _lengthWithoutZeroes(set._inner);
    }
     ...
     * @dev Returns the number of values in the set, excluding zeroes. O(1).
     */
    function lengthWithoutZeroes(UintSet storage set) internal view returns (uint256) {
        return _lengthWithoutZeroes(set._inner);
    }
